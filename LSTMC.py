...
class LSTMC:
    ...
    def __init__(self, max_len=75, emb_dim=32, max_vocab_len=100, w_reg=tf.keras.regularizers.l2(1e-4)):
        ...
        self.model.compile(optimizer=self.adam, loss='binary_crossentropy', metrics=[metrics.F1Score(name="f1"), "accuracy", metrics.Precision(name="precision"), metrics.Recall(name="recall")])
